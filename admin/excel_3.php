...
$ind_hidden=$_POST["ind_hidden"];

$output='';
	
	
		$sql="SELECT * FROM leave_employee_new where assign_to=$ind_hidden";
...
$result = mysql_query("SELECT * FROM leave_employee_new where assign_to=$ind_hidden");
$i=1;
