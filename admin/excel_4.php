...
$code_hidden=$_POST["code_hidden"];
	...
	$output='';
	$sql="SELECT * FROM leave_employee_new join t_employee where leave_employee_new.emp_id=t_employee.emp_id AND t_employee.emp_code='$code_hidden'";
...
$result = mysql_query("SELECT * FROM leave_employee_new join t_employee where leave_employee_new.emp_id=t_employee.emp_id AND t_employee.emp_code='$code_hidden'");
$i=1;
