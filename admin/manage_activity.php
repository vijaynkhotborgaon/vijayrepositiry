...
<form class="form-horizontal" action="manage_activity_process.php" method="post"  role="form">
...
<?php
	...
	<div class="form-group">
      <label class="control-label col-sm-2" for="email"><strong>Map Activity</strong></label>
      <div class="col-sm-10">
        <?php
...
<div class="checkbox-inline">
                        <input type="checkbox" name="Industry_1[]" id="Industry_1" value="<?php echo $rowindustry['act_id']; ?>" /><?php echo $rowindustry['act_name']; ?> <br />
