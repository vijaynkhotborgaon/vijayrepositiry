...
$resultid = mysql_query("SELECT * FROM t_employee where emp_id='$emp_id'");
$i=1;
...
<tr>
    ...
    <td><?php echo $rowindustry['emp_id']; ?></td>
</tr>
<tr>
...
<div class="col-sm-6" style="border: 3px solid #A9E2F3;background:#D8D8D8;">
