...

{
	...
	if(confirm("You want to delete the selected Employee?"))
...
<p id="update_success">Employee Deleted successfully</p>
...
<td><a href="employee_edit.php?emp_id=<?php echo $row['emp_id']; ?>" title="edit"><img src="img/edit.png" alt="Edit Employee Detail" /></a>

<a href="employee_detail.php?emp_id=<?php echo $row['emp_id']; ?>" title="View Details"><img src="img/View-detail.png" alt="View Details" /></a>
...
<a href="javascript:void(0);" onClick="alert('You can not delete this User directly, because employees are working under him/her.')" title="Delete Employee"><img src="img/Delete.png" style="margin-left:5px;" alt="Delete CAM" /></a>
...
<a href="javascript:void(0);" onClick="camdelete('<?php echo $row['emp_id']; ?>')" title="Delete Employee"><img src="img/Delete.png" style="margin-left:5px;" alt="Delete CAM" /></a> 
